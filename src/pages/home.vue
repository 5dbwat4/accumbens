...
import IconList3Twotone from '~icons/line-md/list-3-twotone';
import IconConfettiLineDuotone from '~icons/solar/confetti-line-duotone';
import IconChartLineDuotone from '~icons/solar/chart-line-duotone';
